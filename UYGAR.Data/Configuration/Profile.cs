...
namespace UYGAR.Data.Configuration
{
    ...
    public abstract class Profile : IProfile
    {
        ...
        protected Profile(string name)
        {
            ...
            m_name = DbConnectionBase.GetApplicationDirectory + "\\" + name;
        }
        ...
        protected string DefaultNameWithoutExtension
        {
            get
            {
                try
                {
                    string _dllPath = Assembly.GetExecutingAssembly().CodeBase;
                    string file = _dllPath.Replace("KC.Data.DLL", "connection.config");
        ...
        protected internal virtual void VerifyName()
        {
            if (m_name == null || m_name == "")
                throw new InvalidOperationException("Name özelliði null veya boþ olmasý nedeniyle iþleme izin verilmez.");
        }
        ...
        {
            if (m_readOnly)
                throw new InvalidOperationException("ReadOnly özelliði true olmasý nedeniyle iþleme izin verilmez.");
        }
